...
type
  TForm3 = class(TForm)
    ...
    procedure Button3Click(Sender: TObject); // кнопка ГЛАВНОЕ МЕНЮ
    procedure N2Click(Sender: TObject); // кнопка в меню Игра/Новая
    procedure N4Click(Sender: TObject); // кнопка в меню Игра/Решить
    procedure N3Click(Sender: TObject); // кнопка в меню Игра/Сохранить результаты
    procedure Timer1Timer(Sender: TObject); // отвлеживание времени на игру
    ...
    procedure StringGrid1MouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer); // отслеживание движения мыши по игровому полю
    ...
    procedure FormMouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer); // отслеживание движения мыши по самой форме
  private
...
// Процедура отображения цифр, которые можно поставить в выделенную ячейку
...
//  Если пользователть наводит на ячейку, то отображается над полем
// панель со всевозможными цифрами, коыторые можно в данный момент
// поставить в данную ячейку.
