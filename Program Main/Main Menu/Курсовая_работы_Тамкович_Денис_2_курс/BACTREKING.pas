...
// запускв проыедуры на получения(если возможно) решения для данного судоку
...
// запуск главное функции для возращения ответы о возможности решения судоку
Var
  row,col,num:integer;
  b:boolean;
  l:couple;
...
Procedure get_resh(Var b:tgrid; gl:tgrid; colrows:integer; Var slv:boolean);
// запуск процедуры на получения(если возможно) решения для данного судоку
Var
  i,j:integer;
Begin
  n:=colrows;
